...
- **No Problem/Why section** anywhere in our structure even when the diff is a bug fix (P1.3, P2.2 pending). ✅ Resolved in run 2 (root-cause-first Summary) and run 43 (gated Problem section).
